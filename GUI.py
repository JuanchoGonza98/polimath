...
win.geometry("550x784")  # this is for the size of the window
win.resizable(0, 0)  # this is to prevent from resizing the window
win.title("Polimath 1.01")
...
clear = Button(btns_frame, text="C", fg="black", width=20, height=3, bd=0, bg="#eee", cursor="hand2",
...
point = Button(btns_frame, text="x", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
               command=lambda: btn_click("x")).grid(row=4, column=2, padx=1, pady=1)
